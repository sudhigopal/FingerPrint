...
public class HistogramWindow extends JFrame {
	...
	public HistogramWindow() {
		...
		LayoutManager imagePaneLayout = new BorderLayout(0, 0);
		...
		_histogramPane.setBorder(new EmptyBorder(50, 50, 50, 50));
	 ...
	 */
	public void loadImage(String img) throws IOException {	
